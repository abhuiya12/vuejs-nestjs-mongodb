        ...
        <div class="col-md-12 form-wrapper">
          ...
          <form id="create-post-form" @submit.prevent="editCustomer">
               <div class="form-group col-md-12">
                ...
                <input type="text" id="firstName" v-model="customer.firstName" name="title" class="form-control" placeholder="Enter firstname">
               </div>

               <div class="form-group col-md-12">
                <label for="title"> Last Name </label>
                <input type="text" id="lastName" v-model="customer.lastName" name="title" class="form-control" placeholder="Enter Last name">
               </div>
